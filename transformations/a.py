...
def run_transformation(con):
    ...
    # We need to ensure 'transaction_id' is present in the rejected_cols for testing purposes
    # and to align with the original table structure.
    ...
    # will become NaN and then be dropped from aggregation.
    # The prompt specifically asks for rejection of null year_month, not invalid amounts.
