...
def main():
    ...
    # Ensure account_id is treated as string for null check consistency if it might be mixed type
    accounts_raw_df['account_id'] = accounts_raw_df['account_id'].astype(str).replace('nan', pd.NA)
    ...
    # Ensure account_id is string type for stripping/deduplication
    ...
    for col in string_cols:
        ...
        cleaned_df[col] = cleaned_df[col].astype(str).str.strip().replace('nan', pd.NA)
