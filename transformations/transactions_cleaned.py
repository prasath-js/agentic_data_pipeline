...
def main():
    ...
    try:
        ...
        if transactions_raw_df.empty:
            ...
            con.execute("CREATE OR REPLACE TABLE silver.transactions_cleaned AS SELECT * FROM empty_silver_df;")
            ...
            con.execute("CREATE OR REPLACE TABLE rejected.rejected_rows AS SELECT * FROM empty_rejected_df;")
            return
        ...
        if not rejected_df.empty:
            ...
            # This is done on validation_df to align reasons with original indices
        ...
        if not rejected_df.empty:
            ...
            con.execute("CREATE OR REPLACE TABLE rejected.rejected_rows AS SELECT * FROM temp_rejected_schema_df;")
