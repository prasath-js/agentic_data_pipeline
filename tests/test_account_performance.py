...
def duckdb_connection():
    ...
    """
    # Removed the initial os.remove(DB_PATH) to avoid PermissionError if file is locked by external process.
    # We will rely on DROP TABLE IF EXISTS in run_transformation for cleanup of content.
    # The file itself will be attempted to be removed at the end of the module.
    ...
    if os.path.exists(DB_PATH):
        try:
            ...
            print(f"Warning: An unexpected error occurred while removing DB file {DB_PATH}: {e}")
