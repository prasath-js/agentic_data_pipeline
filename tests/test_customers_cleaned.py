...
def duckdb_connection():
    ...
    con.execute("""
        ...
        (1.0, ' John Doe ', 'john.doe.old@example.com', '123 Main St', '2022-12-31', 'file1.csv', '2023-01-01T00:00:00'), -- Duplicate, older date
    ...
    con.close()
    # For actual cleanup, you might want to delete the DB file or drop schemas
