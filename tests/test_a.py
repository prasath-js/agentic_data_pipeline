...
def setup_database():
    ...
    transactions_data = {
        ...
        'amount': [100.0, 200.0, 150.0, 250.0, 300.0, 100.0, 50.0, 75.0, 120.0, 180.0, 200.0, 'invalid_amount'], # Added invalid amount
        'transaction_date': [
            '2023-01-01', '2023-01-15',  # Jan: 300 (100+200)
            '2023-02-01', '2023-02-10',  # Feb: 400 (150+250) -> 33.33% growth from Jan
            '2023-03-05', '2023-03-20',  # Mar: 400 (300+100) -> 0% growth from Feb
            'invalid-date',              # Rejected (null year_month)
            None,                        # Rejected (null year_month)
            '2023-04-01', '2023-04-10',  # Apr: 300 (50+75+120+180 = 425, wait, this is wrong. Let's adjust amounts for clarity)
            '2023-05-01',                # May: 200 (200)
            '2023-05-10'                 # May: invalid amount, will be dropped from aggregation, but not rejected for date
        ]
    }
    # Adjust amounts for clearer MoM growth calculation
    transactions_data['amount'] = [
        ...
        120.0, 180.0, # Apr: 300
        200.0,        # May: 200
        'invalid_amount' # May: invalid amount, dropped
    ]
