...
def setup_database():
    ...
    # Connect for setup and transformation
    ...
    # Run the main transformation AFTER setting up bronze data
    # The main() function will open its own connection and close it.
    main()

    con.close() # Close the connection used by the fixture itself
