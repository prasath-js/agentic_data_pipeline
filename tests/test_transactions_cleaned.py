...
def setup_database():
    ...
    test_data = [
        ...
        # Rejected: Non-numeric amount
        (108.0, 8.0, 6.0, "abc", "2023-01-08", "file8.csv", "ts8"),
        # Rejected: Null transaction_id AND invalid amount
    ...
    con.execute("CREATE OR REPLACE TABLE bronze.transactions_raw AS SELECT * FROM transactions_raw_df;", parameters={'transactions_raw_df': transactions_raw_df})
