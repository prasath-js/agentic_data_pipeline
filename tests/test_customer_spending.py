...
def db_setup_and_teardown():
    ...
    try:
        ...
        customers_data = {
            ...
            'join_date': pd.to_datetime(['2023-01-01', '2023-01-05', '2023-01-10', '2023-01-15', '2023-01-20'])
        }
        ...
        transactions_data = {
            ...
            'transaction_date': pd.to_datetime(['2023-02-01', '2023-02-02', '2023-02-03', '2023-02-04', '2023-02-05', '2023-02-06', '2023-02-07', '2023-02-08', '2023-02-09', '2023-02-10', '2023-02-11', '2023-02-12', '2023-02-13'])
        }
...
def test_rejected_rows_content(duckdb_connection):
    ...
    # Convert 'original_transaction_customer_id' to object type for comparison if it's not already
    # This handles potential type differences between DuckDB's VARCHAR and Pandas' object/string
    rejected_df['original_transaction_customer_id'] = rejected_df['original_transaction_customer_id'].astype(object)
    expected_rejected['original_transaction_customer_id'] = expected_rejected['original_transaction_customer_id'].astype(object)
