...
@pytest.fixture(scope="module") # Scope remains module
def setup_bronze_data(): # Removed duckdb_connection dependency here
    ...
    # Teardown: Open another connection for cleanup
